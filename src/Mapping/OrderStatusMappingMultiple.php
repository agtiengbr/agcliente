...
class OrderStatusMappingMultiple implements MappingInterface
{
    ...
    {
        \Configuration::updateValue($this->getConfigName(), implode('-', $value));
    }

    public function getMappedValue()
    {
        return explode('-', \Configuration::get($this->getConfigName()));
    }
